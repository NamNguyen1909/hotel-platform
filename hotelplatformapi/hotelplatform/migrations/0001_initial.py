# Generated by Django 5.2.4 on 2025-08-11 14:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('user_group', models.CharField(blank=True, choices=[('new', 'Khách hàng mới'), ('regular', 'Khách phổ thông'), ('vip', 'Khách VIP'), ('super_vip', 'Khách siêu VIP'), ('unknown', 'Không xác định')], help_text='Nhóm khách hàng áp dụng. Để trống nếu áp dụng cho tất cả.', max_length=10, null=True)),
            ],
            options={
                'indexes': [models.Index(fields=['code', 'is_active'], name='hotelplatfo_code_2f14f8_idx'), models.Index(fields=['user_group', 'is_active'], name='hotelplatfo_user_gr_f5d7d2_idx')],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['room', 'is_primary'], name='hotelplatfo_room_id_7e90e2_idx'),
        ),
        migrations.AddIndex(
